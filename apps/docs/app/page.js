...
const code_1 = require("@repo/ui/code");
...
function Page() {
    return (<main className={page_module_css_1.default.main}>
      <div className={page_module_css_1.default.description}>
        <p>
          examples/basic&nbsp;
          <code_1.Code className={page_module_css_1.default.code}>docs</code_1.Code>
        </p>
        <div>
          <a href="https://vercel.com?utm_source=create-turbo&utm_medium=basic&utm_campaign=create-turbo" rel="noopener noreferrer" target="_blank">
            By{" "}
            <image_1.default alt="Vercel Logo" className={page_module_css_1.default.vercelLogo} height={24} priority src="/vercel.svg" width={100}/>
          </a>
        </div>
      </div>

      <button_1.Button appName="web" className={page_module_css_1.default.button}>
        Click me!
      </button_1.Button>

      <div className={page_module_css_1.default.hero}>
        <div className={page_module_css_1.default.heroContent}>
          <div className={page_module_css_1.default.logos}>
            <div className={page_module_css_1.default.circles}>
              <image_1.default alt="Turborepo" height={614} src="circles.svg" width={614} style={{ pointerEvents: "none" }}/>
            </div>
            <div className={page_module_css_1.default.logoGradientContainer}>
              <Gradient className={page_module_css_1.default.logoGradient} conic small/>
            </div>

            <div className={page_module_css_1.default.logo}>
              <image_1.default alt="" height={120} priority src="turborepo.svg" width={120} style={{ pointerEvents: "none" }}/>
            </div>
          </div>
          <Gradient className={page_module_css_1.default.backgroundGradient} conic/>
          <div className={page_module_css_1.default.turborepoWordmarkContainer}>
            <svg className={page_module_css_1.default.turborepoWordmark} viewBox="0 0 506 50" width={200} xmlns="http://www.w3.org/2000/svg">
      ...
      <div className={page_module_css_1.default.grid}>
        {LINKS.map(({ title, href, description }) => (<card_1.Card className={page_module_css_1.default.card} href={href} key={title} title={title}>
            {description}
          </card_1.Card>))}
      </div>
    </main>);
