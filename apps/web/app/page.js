...
function Page() {
    return (<main className={page_module_css_1.default.main}>
      <div className={page_module_css_1.default.description}>
        <p>
          examples/basic&nbsp;
          <code_1.Code className={page_module_css_1.default.code}>web</code_1.Code>
        </p>
        <div>
        ...
        <div className={page_module_css_1.default.heroContent}>
          <div className={page_module_css_1.default.logos}>
            <div className={page_module_css_1.default.circles}>
              <image_1.default alt="" height={614} src="circles.svg" width={614} style={{ pointerEvents: "none" }}/>
            </div>
            ...
            <div className={page_module_css_1.default.logo}>
              <image_1.default alt="Turborepo" height={120} priority src="turborepo.svg" width={120} style={{ pointerEvents: "none" }}/>
            </div>
          </div>
